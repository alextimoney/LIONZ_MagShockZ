...
if __name__ == "__main__":
    ...
    z_min = -8.5e-3      # = -width [m] * slices/2          
    z_max = 8.5e-3       # = width [m] * slices/2
    Nz = 272             # number of slices
    ...
    output_dir = f"/home/timoney/scratch/timoney/MagShockZ/traces/2d_noshield/raytrace_{ID}"
