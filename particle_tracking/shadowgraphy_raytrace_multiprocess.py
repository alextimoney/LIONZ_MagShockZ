...
def solve_beam(args):
    proc_id, x_coords, y_coords, z_coords, electron_density, Np_per_proc, beam_size, divergence = args
    ...
    logger.info(f"Process {proc_id}: ElectronCube created with shape {electron_density.shape}")
    cube.external_ne(electron_density)
...
if __name__ == "__main__":
    ...
    # This assumes FLASH data is in cgs
